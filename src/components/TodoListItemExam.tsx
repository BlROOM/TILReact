...
const TodoListItem = ({ todo }: { todo: TTodo }) => {
  return (
    <>
      <li className="flex items-center py-[10px] px-[15px] bg-[rgba(53,56,62,0.05)] border border-[#4f4f4f] rounded-[8px]">
        ...
        <button className="w-6 h-6 bg-[rgba(53,56,62,0.1)] border border-[#4F4F4F] rounded flex items-center align-middle justify-center">
          <svg
            width="15"
            height="16"
            viewBox="0 0 15 16"
